...
export default function Reading() {
  ...
  if (!bookId) {
    ...
    return <div className="page reading-page">
      ...
      {candidates===null?<p role="status" className="card">Loading your reading list…</p>:!all.length?<section className="card reading-empty"><LibraryBig size={32}/><h2>Your next chapter starts here</h2><p>Upload a PDF or EPUB above, or add a printed book to your Library.</p><Link to="/shelf/add" className="btn btn-primary">Add your first book</Link></section>:<>
